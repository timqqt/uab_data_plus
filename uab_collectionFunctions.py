...
class uabCollection(object):
    ...
    def setExtensions(self, doSplit=1):
        ...
        if os.path.exists(metFileName):
            ...
            print(os.path.join(self.imDirectory, uabCollection.dataDirnames['data'], uabCollection.colDirnames['orig']))
            print(self.tileList)
    ...
    def loadTileDataByExtension(self, tile, extId):
        ...
        #print('What is the tile name into loading?: ', tileDataPath)
    ...
    def getChannelMeans(self, extId):
        ...
        with open(metaInfoName, 'rb') as f:
            meta = pickle.load(f)
        mean_info = meta['mean']
        #mean_info = np.load(metaInfoName)['mean']

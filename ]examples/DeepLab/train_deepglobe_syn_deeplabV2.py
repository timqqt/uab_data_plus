...
model_name = 'Joint_training_syn_and_deepglobe_Deeplabv2_6'
...
file_list_train = list(np.concatenate((file_list_train_Vegas, file_list_train_Shanghai, file_list_train_Paris, file_list_train_Khartoum, file_list_train_Syn), axis=0))
